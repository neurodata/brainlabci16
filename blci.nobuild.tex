...
\renewcommand{\thesection}{\alpha{section}}   % set the section counter to Alpha
\renewcommand{\thesubsection}{\alpha{section}(\arabic{subsection})}   % set the subsection counter to alpha
\renewcommand{\thesubsubsection}{\arabic{section}(\alph{subsection}).\arabic{subsubsection}}   % set the subsection counter to alpha
...
\author{{Randal Burns (PI) }\\
         ...
         \\
         Joshua T. Western and Michael I. Miller\\
